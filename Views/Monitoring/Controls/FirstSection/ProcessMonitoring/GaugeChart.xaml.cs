...
namespace HyunDaiINJ.Views.Monitoring.Controls.FirstSection.ProcessMonitoring
{
    public partial class GaugeChart : UserControl
    {
        private readonly GaugeChartViewModel _viewModel;

        public GaugeChart()
        {
            InitializeComponent();
            _viewModel = new GaugeChartViewModel();
